...
class AylaP2(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.load_sprites('walk', start_row=2, num_frames=8)
        self.load_sprites('attack1', start_row=7, num_frames=7)
        self.load_sprites('attack2', start_row=8, num_frames=21)
        self.load_sprites('attack3', start_row=9, num_frames=27)
        self.load_sprites('super_attack', start_row=10, num_frames=32)
        self.load_sprites('block', start_row=12, num_frames=9)
        self.load_sprites('roll', start_row=6, num_frames=6)
        self.load_sprites('air_attack', start_row=5, num_frames=8)
        self.load_sprites('hit', start_row=13, num_frames=7)
        self.load_sprites('up',start_row=3,num_frames=3)
        self.load_sprites('down',start_row=4,num_frames=3)
    ...
    def update_attack_rect(self):
        if self.current_action == 'attack1':
            if self.flip:
                if 1 <= self.index < 5:
                    self.attack_rect = pygame.Rect(self.rect.x + 160, self.rect.y + self.rect.height - 65, 85, 30)  # Retângulo de ataque 1
                else:
                    self.attack_rect = pygame.Rect(0, 0, 0, 0)  # Ataque inativo
            else:
                if 1 <= self.index < 7:
                    self.attack_rect = pygame.Rect(self.rect.x + 325, self.rect.y + self.rect.height - 65, 85, 30)  # Retângulo de ataque 1
                else:
                    self.attack_rect = pygame.Rect(0, 0, 0, 0)  # Ataque inativo
        elif self.current_action == 'attack2':
            if self.flip:
                if 1 <= self.index < 4:
                    self.attack_rect = pygame.Rect(self.rect.x + 160, self.rect.y + self.rect.height - 65, 85, 30)  # Retângulo de ataque 2
                elif 5 <= self.index < 11:
                    self.attack_rect = pygame.Rect(self.rect.x + 235, self.rect.y + self.rect.height - 100, 95, 80)
                elif 12<= self.index < 17:
                    self.attack_rect = pygame.Rect(self.rect.x + 125, self.rect.y + self.rect.height - 75, 125, 50)
                elif self.index == 17:
                    self.attack_rect = pygame.Rect(self.rect.x + 160, self.rect.y + self.rect.height - 65, 85, 30)
                else:
                    self.attack_rect = pygame.Rect(0, 0, 0, 0)  # Ataque inativo
            else:
                if 1 <= self.index < 4:
                    self.attack_rect = pygame.Rect(self.rect.x + 325, self.rect.y + self.rect.height - 65, 85, 30)  # Retângulo de ataque 2
                elif 5 <= self.index < 11:
                    self.attack_rect = pygame.Rect(self.rect.x + 240, self.rect.y + self.rect.height - 100, 95, 80)
                elif 12<= self.index < 17:
                    self.attack_rect = pygame.Rect(self.rect.x + 325, self.rect.y + self.rect.height - 75, 125, 50)
                elif self.index == 17:
                    self.attack_rect = pygame.Rect(self.rect.x + 325, self.rect.y + self.rect.height - 65, 85, 30)
                else:
                    self.attack_rect = pygame.Rect(0, 0, 0, 0)  # Ataque inativo
            ...
            if self.flip:
                if 1 <= self.index < 4:
                    ...
                    self.attack_rect = pygame.Rect(self.rect.x + 235, self.rect.y + self.rect.height - 100, 95, 80)
                elif 12<= self.index < 16:
                    self.attack_rect = pygame.Rect(self.rect.x + 125, self.rect.y + self.rect.height - 75, 125, 50)
                elif 16<= self.index < 21:
                    self.attack_rect = pygame.Rect(self.rect.x + 190, self.rect.y + self.rect.height - 115, 105, 90)
                elif 21<= self.index < 26:
                    self.attack_rect = pygame.Rect(self.rect.x + 85, self.rect.y + self.rect.height - 110, 120, 115)
                else:
                ...
                if 1 <= self.index < 4:
                    ...
                    self.attack_rect = pygame.Rect(self.rect.x + 285, self.rect.y + self.rect.height - 115, 105, 90)
                elif 21<= self.index < 26:
                    self.attack_rect = pygame.Rect(self.rect.x + 370, self.rect.y + self.rect.height - 110, 120, 115)
                else:
                    self.attack_rect = pygame.Rect(0, 0, 0, 0)  
        elif self.current_action == 'air_attack':
            if self.flip:
                if 2 <= self.index < 8:
                    self.attack_rect = pygame.Rect( self.rect.x + 125, self.rect.y + 164, 125, 45) # Air ataque
                else:
                    self.attack_rect = pygame.Rect(0, 0, 0, 0)  # Ataque inativo
            else:
                if 2 <= self.index < 8:
                    self.attack_rect = pygame.Rect(self.rect.x + 320 , self.rect.y + 164, 125, 45)  # Air ataque
                else:
                    self.attack_rect = pygame.Rect(0, 0, 0, 0)  # Ataque inativo
        elif self.current_action == 'super_attack':
            if self.flip:
                if 12 <= self.index <= 28:
                    self.attack_rect = pygame.Rect(self.rect.x + 85, self.rect.y + self.rect.height - 54, 175, 60)  # Super ataque
                else:
                    self.attack_rect = pygame.Rect(0, 0, 0, 0)  # Ataque inativo
            else:
                if 12 <= self.index <= 28:
                    self.attack_rect = pygame.Rect(self.rect.x + 312, self.rect.y + self.rect.height - 54, 175, 60)  # Super ataque
                else:
                    self.attack_rect = pygame.Rect(0, 0, 0, 0)  # Ataque inativo
        else:
