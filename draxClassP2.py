...
class DraxP2(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.load_sprites('attack1', start_row=7, num_frames=7)
        self.load_sprites('attack2', start_row=8, num_frames=7)
        self.load_sprites('attack3', start_row=9, num_frames=17)
        self.load_sprites('super_attack', start_row=10,num_frames=15)
        self.load_sprites('block', start_row=11, num_frames=9)
        self.load_sprites('roll', start_row=6, num_frames=8)
        self.load_sprites('air_attack', start_row=5, num_frames=8)
        self.load_sprites('hit', start_row=12, num_frames=6)
    ...
    def update_attack_rect(self):
        if self.current_action == 'attack1':
            if self.flip:
                if 1 <= self.index < 7:
                    self.attack_rect = pygame.Rect(self.rect.x + 205, self.rect.y + self.rect.height - 105, 100, 90)  # Retângulo de ataque 1
                else:
                    self.attack_rect = pygame.Rect(0, 0, 0, 0)  # Ataque inativo
            else:
                if 1 <= self.index < 7:
                    self.attack_rect = pygame.Rect(self.rect.x + 272, self.rect.y + self.rect.height - 105, 100, 90)  # Retângulo de ataque 1
                else:
                    self.attack_rect = pygame.Rect(0, 0, 0, 0)  # Ataque inativo
        elif self.current_action == 'attack2':
            if self.flip:
                if 1 <= self.index < 7:
                    self.attack_rect = pygame.Rect(self.rect.x + 213, self.rect.y + self.rect.height - 120, 95, 95)  # Retângulo de ataque 2
                else:
                    self.attack_rect = pygame.Rect(0, 0, 0, 0)  # Ataque inativo
            else:
                if 1 <= self.index < 7:
                    self.attack_rect = pygame.Rect(self.rect.x + 272, self.rect.y + self.rect.height - 120, 95, 95)  # Retângulo de ataque 2
                else:
                    self.attack_rect = pygame.Rect(0, 0, 0, 0)  # Ataque inativo
        elif self.current_action == 'attack3':
            if self.flip:
                if 0 <= self.index < 2:
                    self.attack_rect = pygame.Rect(self.rect.x + 205, self.rect.y + self.rect.height - 36, 48, 36)  # Retângulo de ataque 3
                elif 3 <= self.index < 5:
                    self.attack_rect = pygame.Rect(self.rect.x + 155, self.rect.y + self.rect.height - 36, 48, 36)
                elif 5 <= self.index < 7:
                    self.attack_rect = pygame.Rect(self.rect.x + 123, self.rect.y + self.rect.height - 36, 48, 36)
                elif self.index == 7:
                    self.attack_rect = pygame.Rect(self.rect.x + 117, self.rect.y + self.rect.height - 48, 48, 48)
                elif 8 <= self.index <= 14:
                    self.attack_rect = pygame.Rect(self.rect.x + 30, self.rect.y + self.rect.height - 112, 128, 112)
                else:
                    self.attack_rect = pygame.Rect(0, 0, 0, 0)  # Ataque inativo
            else:
                if 0 <= self.index < 2:
                    self.attack_rect = pygame.Rect(self.rect.x + 320, self.rect.y + self.rect.height - 36, 48, 36)  # Retângulo de ataque 3
                elif 3 <= self.index < 5:
                    self.attack_rect = pygame.Rect(self.rect.x + 368, self.rect.y + self.rect.height - 36, 48, 36)
                elif 5 <= self.index < 7:
                    self.attack_rect = pygame.Rect(self.rect.x + 400, self.rect.y + self.rect.height - 48, 70, 48)
                elif self.index == 7:
                    self.attack_rect = pygame.Rect(self.rect.x + 406, self.rect.y + self.rect.height - 48, 70, 48)
                elif 8 <= self.index <= 14:
                    self.attack_rect = pygame.Rect(self.rect.x + 416, self.rect.y + self.rect.height - 112, 128, 112)
                else:
                    self.attack_rect = pygame.Rect(0, 0, 0, 0)  # Ataque inativo
        elif self.current_action == 'air_attack':
            if self.flip:
                if 2 <= self.index < 8:
                    self.attack_rect = pygame.Rect(self.rect.x + 200, self.rect.y + self.rect.height - 125, 90, 112)  # Air ataque
                else:
                    self.attack_rect = pygame.Rect(0, 0, 0, 0)  # Ataque inativo
            else:
                if 2 <= self.index < 8:
                    self.attack_rect = pygame.Rect(self.rect.x + 288, self.rect.y + self.rect.height - 125, 90, 112)  # Air ataque
                else:
                    self.attack_rect = pygame.Rect(0, 0, 0, 0)  # Ataque inativo
        elif self.current_action == 'super_attack':
            if self.flip:
                if 6 <= self.index <= 7:
                    self.attack_rect = pygame.Rect(self.rect.x + 144, self.rect.y + self.rect.height - 64, 80, 64)  # Super ataque
                elif 8 <= self.index <= 12:
                    self.attack_rect = pygame.Rect(self.rect.x, self.rect.y + self.rect.height - 144, 160, 144)
                else:
                    self.attack_rect = pygame.Rect(0, 0, 0, 0)  # Ataque inativo
            else:
                if 6 <= self.index <= 7:
                    self.attack_rect = pygame.Rect(self.rect.x + 336, self.rect.y + self.rect.height - 64, 80, 64)  # Super ataque
                elif 8 <= self.index <= 12:
                    self.attack_rect = pygame.Rect(self.rect.x + 416, self.rect.y + self.rect.height - 144, 160, 144)
                else:
                    self.attack_rect = pygame.Rect(0, 0, 0, 0)  # Ataque inativo
        else:
